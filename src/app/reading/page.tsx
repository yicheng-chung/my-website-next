  ...
  return (
    <div className="flex flex-col gap-6 sm:gap-8">
      <div className="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8 dark:border-neutral-700 dark:bg-neutral-800">
        <h1 className="mb-2 text-2xl font-bold text-[#577E89] sm:text-3xl dark:text-[#9BB8C2]">
          {t.heading}
        </h1>
        <p className="text-sm text-neutral-500 dark:text-neutral-400">{t.sourceNote}</p>
      </div>
      ...
      <section>
        ...
        {data && data.reading.length === 0 && (
          <p className="text-sm text-neutral-500 dark:text-neutral-400">{t.emptyReading}</p>
        )}
      ...
      <section>
        ...
        {data && data.finished.length === 0 && (
          <p className="text-sm text-neutral-500 dark:text-neutral-400">{t.emptyFinished}</p>
        )}
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 md:grid-cols-4">
